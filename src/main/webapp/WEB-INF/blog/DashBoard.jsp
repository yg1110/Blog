...
<script src="/main/js/jquery.min.js">
	
</script>
<!-- Mainly scripts -->
<script src="/main/js/jquery.metisMenu.js"></script>
...
<!--pie-chart--->
<script src="/main/js/pie-chart.js" type="text/javascript"></script>
...
<!--skycons-icons-->
<script src="/main/js/skycons.js"></script>
<!--//skycons-icons-->
</head>
<body>
					...
					<ul class=" nav_1">
						...
						<li class="dropdown"><a href="#"
							class="dropdown-toggle dropdown-at" data-toggle="dropdown"><span
								class=" name-caret">${name}<i class="caret"></i></span><img
								src="/main/images/wo.jpg"></a>
			...
			<div class="content-main">
				...
				<div class="content-top">
					...
					<div class="col-md-8 content-top-2">
						...
						<div class="content-graph">
							...
							<!--graph-->
							<link rel="stylesheet" href="/main/css/graph.css">
							<!--//graph-->
				...
				<div class="content-mid">
					...
					<div class="col-md-5">
						...
						<!----Calender -------->
						<link rel="stylesheet" href="/main/css/clndr.css" type="text/css" />
						<script src="/main/js/underscore-min.js" type="text/javascript"></script>
						<script src="/main/js/moment-2.2.1.js" type="text/javascript"></script>
						<script src="/main/js/clndr.js" type="text/javascript"></script>
							...
							<div id="owl-demo" class="owl-carousel text-center">
								<div class="item">
									<img class="lazyOwl img-responsive"
										data-src="/main/images/na.jpg" alt="name">
								</div>
								<div class="item">
									<img class="lazyOwl img-responsive"
										data-src="/main/images/na1.jpg" alt="name">
								</div>
								<div class="item">
									<img class="lazyOwl img-responsive"
										data-src="/main/images/na2.jpg" alt="name">
								</div>
								<div class="item">
									<img class="lazyOwl img-responsive"
										data-src="/main/images/na.jpg" alt="name">
					...
					<div class="col-md-6 post-top">
						...
						<div class="post-bottom">
							<div class="post-bottom-1">
								...
								<p>
									15k <label>Likes</label>
								</p>
							</div>
							<div class="post-bottom-2">
								<a href="#"><i class="fa fa-twitter"></i></a>
								<p>
									20M <label>Followers</label>
								</p>
							</div>
							<div class="clearfix"></div>
						</div>
